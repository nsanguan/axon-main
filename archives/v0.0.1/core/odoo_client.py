"""
AxonOdooXMLRPCClient — Axon's built-in Odoo MCP adapter (thin xmlrpc.client wrapper).

This module is the Odoo-specific connector.  Axon is ERP-agnostic: other ERP
adapters (SAP, Oracle, custom) can be added as separate modules alongside this
one and exposed through their own MCP servers.
